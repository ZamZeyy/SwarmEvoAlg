...
public class DemandPrediction {
    ...
    public DemandPrediction(String dataset) throws IOException {
        if (Objects.equals(dataset, "train"))
            load_dataset("data/train.csv");
        else if (Objects.equals(dataset, "test"))
            load_dataset("data/test.csv");
        else
            throw new IllegalArgumentException("Only permitted arguments for " +
    ...
    public boolean is_valid(double[] parameters) {
        if (parameters.length != N_PARAMETERS)
            return false;
